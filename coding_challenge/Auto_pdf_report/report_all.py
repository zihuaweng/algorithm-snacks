...
"""
	This script is to :
		generate a batch of urinary_project individual reports for each 16s_pipeline_output to specific dir

	Usafe:
		python script.py [qiime_file_dir] [phynotype.file] [out_dir_new]
...
script, dir, phy, output_dir = sys.argv
